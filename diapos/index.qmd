...
4. Determina las [**5 canciones que más semanas**]{.hl-yellow} aparecen en la lista de éxitos. 
. . .

5. Determina el [**artista con más canciones**]{.hl-yellow} en la lista

. . .

6. Calcula el [**número de canciones distintas**]{.hl-yellow} de cada artista
...
7. Calcula la [**posición más alta**]{.hl-yellow} en la que ha estado cada canción. Calcula la posición más alta en la que ha estado un artista

. . .

8. Calcula la [**primera semana que cada canción entró**]{.hl-yellow} en el top 100
...
## 🐣 Caso práctico 9: funciones {#caso9a}
