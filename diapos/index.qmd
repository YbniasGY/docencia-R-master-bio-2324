...
El método de imputación será crucial, de hecho si imputamos los ausentes de las variables numéricas por la media, esto es lo que obtenemos
...
El método de imputación será crucial, de hecho si imputamos los ausentes de las variables numéricas por la media, esto es lo que obtenemos (provocado por un sobreajuste).
